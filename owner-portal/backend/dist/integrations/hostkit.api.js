...
exports.getHostkitSaft = exports.generateHostkitSaft = exports.getHostkitTouristTax = exports.getHostkitReservations = exports.getHostkitReservation = exports.getLastHostkitSibaDate = exports.sendHostkitSiba = exports.validateHostkitSiba = exports.getChannelBookings = exports.updateHostkitCalendar = exports.getHostkitInvoices = exports.createHostkitCreditNote = exports.getHostkitCreditNotes = void 0;
const axios_1 = __importDefault(require("axios"));
const propertyApiKey_1 = require("../utils/propertyApiKey");
const HOSTKIT_BASE_URL = process.env.HOSTKIT_API_URL;
const HOSTAWAY_ACCOUNT_ID = process.env.HOSTAWAY_ACCOUNT_ID;
const getHostkitCreditNotes = async (listingId, startDate, endDate, status) => {
    try {
        ...
        const { data } = await axios_1.default.get(`${HOSTKIT_BASE_URL}/getCreditNotes`, {
            params
        });
...
exports.getHostkitCreditNotes = getHostkitCreditNotes;
const createHostkitCreditNote = async (listingId, invoiceId, invoiceSeries, options) => {
    try {
        ...
        const { data } = await axios_1.default.get(`${HOSTKIT_BASE_URL}/addCreditNote`, {
            params
        });
        return data;
    }
...
exports.createHostkitCreditNote = createHostkitCreditNote;
const getHostkitInvoices = async (listingId, startDate, endDate) => {
    try {
        const dateStart = Math.floor(new Date(startDate).getTime() / 1000);
        const dateEnd = Math.floor(new Date(endDate).getTime() / 1000);
        ...
        const { data } = await axios_1.default.get(`${HOSTKIT_BASE_URL}/getInvoices`, {
            params
        });
...
exports.getHostkitInvoices = getHostkitInvoices;
const updateHostkitCalendar = async (listingId, startDate, endDate, status) => {
    try {
        ...
        const dateEnd = Math.floor(new Date(endDate).getTime() / 1000);
        // Use the property-specific API key mapping (same as other services)
        const apiKey = await (0, propertyApiKey_1.getHostkitApiKey)(listingId);
        if (!apiKey) {
            throw new Error(`No API key found for property ${listingId}`);
        }
        // Get the Hostkit property ID for this listing
        ...
        const { data } = await axios_1.default.get(`${HOSTKIT_BASE_URL}/updateCalendar`, {
            params: {
                APIKEY: apiKey,
                listing_id: hostkitPropertyId, // Use Hostkit ID, not Hostaway ID
                date_start: dateStart,
...
exports.updateHostkitCalendar = updateHostkitCalendar;
const getChannelBookings = async (propertyId, startDate, endDate) => {
    try {
        const dateStart = Math.floor(new Date(startDate).getTime() / 1000);
        const dateEnd = Math.floor(new Date(endDate).getTime() / 1000);
        // Use the property-specific API key mapping (same as other services)
        ...
        const { data } = await axios_1.default.get(`${HOSTKIT_BASE_URL}/getBookings`, {
            params: {
                APIKEY: apiKey,
                account_id: HOSTAWAY_ACCOUNT_ID,
...
exports.getChannelBookings = getChannelBookings;
// SIBA (Municipal Tax) API Functions - Using Hostkit API
const validateHostkitSiba = async (listingId, reservationCode) => {
    try {
        const propertyApiKey = await (0, propertyApiKey_1.getHostkitApiKey)(listingId);
        if (!propertyApiKey) {
            throw new Error(`No API key found for property ${listingId}`);
        ...
        const response = await axios_1.default.get(`${HOSTKIT_BASE_URL}/validateSIBA`, { params });
...
exports.validateHostkitSiba = validateHostkitSiba;
const sendHostkitSiba = async (listingId, reservationCode) => {
    try {
        const propertyApiKey = await (0, propertyApiKey_1.getHostkitApiKey)(listingId);
        if (!propertyApiKey) {
            throw new Error(`No API key found for property ${listingId}`);
        ...
        const response = await axios_1.default.get(`${HOSTKIT_BASE_URL}/sendSIBA`, { params });
...
exports.sendHostkitSiba = sendHostkitSiba;
const getLastHostkitSibaDate = async (listingId) => {
    try {
        const propertyApiKey = await (0, propertyApiKey_1.getHostkitApiKey)(listingId);
        if (!propertyApiKey) {
            throw new Error(`No API key found for property ${listingId}`);
        ...
        const response = await axios_1.default.get(`${HOSTKIT_BASE_URL}/getLastSIBADate`, { params });
...
exports.getLastHostkitSibaDate = getLastHostkitSibaDate;
const getHostkitReservation = async (listingId, reservationCode) => {
    try {
        const propertyApiKey = await (0, propertyApiKey_1.getHostkitApiKey)(listingId);
        if (!propertyApiKey) {
            throw new Error(`No API key found for property ${listingId}`);
        ...
        const response = await axios_1.default.get(`${HOSTKIT_BASE_URL}/getReservation`, { params });
...
exports.getHostkitReservation = getHostkitReservation;
const getHostkitReservations = async (listingId, startDate, endDate) => {
    try {
        const dateStart = Math.floor(new Date(startDate).getTime() / 1000);
        const dateEnd = Math.floor(new Date(endDate).getTime() / 1000);
        // Use the property-specific API key mapping (same as other services)
        ...
        const { data } = await axios_1.default.get(`${HOSTKIT_BASE_URL}/getReservations`, { params });
        return data;
    }
    catch (error) {
...
exports.getHostkitReservations = getHostkitReservations;
const getHostkitTouristTax = async (propertyId, startDate, endDate) => {
    try {
        const dateStart = Math.floor(new Date(startDate).getTime() / 1000);
        const dateEnd = Math.floor(new Date(endDate).getTime() / 1000);
        // Use the property-specific API key mapping (same as other services)
        ...
        const { data } = await axios_1.default.get(`${HOSTKIT_BASE_URL}/getTouristTax`, {
            params: {
                APIKEY: apiKey,
                account_id: HOSTAWAY_ACCOUNT_ID,
                property_id: hostkitPropertyId, // Use Hostkit ID, not Hostaway ID
...
exports.getHostkitTouristTax = getHostkitTouristTax;
// SAFT Generation Functions
const generateHostkitSaft = async (propertyId, year, month) => {
    try {
        ...
        const { data } = await axios_1.default.get(`${HOSTKIT_BASE_URL}/generateSAFT`, {
            params: {
                APIKEY: apiKey,
                invoicing_nif: invoicingNif,
                year,
...
exports.generateHostkitSaft = generateHostkitSaft;
const getHostkitSaft = async (propertyId, year, month) => {
    try {
        ...
        const { data } = await axios_1.default.get(`${HOSTKIT_BASE_URL}/getSAFT`, {
            params: {
                APIKEY: apiKey,
                invoicing_nif: invoicingNif,
                year,
...
exports.getHostkitSaft = getHostkitSaft;
