...
exports.getAdvancedCalendarEventsService = getAdvancedCalendarEventsService;
exports.createAdvancedCalendarEventService = createAdvancedCalendarEventService;
exports.updateAdvancedCalendarEventService = updateAdvancedCalendarEventService;
exports.deleteAdvancedCalendarEventService = deleteAdvancedCalendarEventService;
exports.getBulkOperationsService = getBulkOperationsService;
exports.createBulkOperationService = createBulkOperationService;
exports.getEventTemplatesService = getEventTemplatesService;
...
async function getAdvancedCalendarEventsService(propertyId, startDate, endDate, userId) {
    ...
    try {
        ...
        if (propertyId && startDate && endDate) {
            ...
            if (hasHostawayToken) {
                try {
                    ...
                    const hostawayCalendar = await (0, hostaway_api_1.getHostawayCalendar)(propertyId, startDate, endDate);
            ...
            if (hasHostkitUrl) {
                try {
                    ...
                    const hostkitBookings = await (0, hostkit_api_1.getChannelBookings)(propertyId, startDate, endDate);
                    ...
                    if (Array.isArray(hostkitBookings)) {
                        ...
                        const hostkitEvents = hostkitBookings
                            .filter((booking) => booking.status === 'blocked' || booking.status === 'unavailable')
                            .map((booking, index) => {
                            // Try different possible field names for reason/description
        ...
        const mockEventsForProperty = mockEvents.filter(event => !propertyId || event.propertyId === propertyId);
        ...
        return mockEvents.filter(event => (!propertyId || event.propertyId === propertyId) &&
            (!startDate || !endDate || (new Date(event.startDate) >= new Date(startDate) &&
                new Date(event.endDate) <= new Date(endDate))));
    }
}
async function createAdvancedCalendarEventService(eventData, userId) {
    ...
    try {
        ...
        if (eventType === 'block') {
            ...
            try {
                await (0, hostaway_api_1.updateHostawayCalendar)(propertyId, startDate, endDate, 'blocked');
            ...
            // Try Hostkit API
            try {
                await (0, hostkit_api_1.updateHostkitCalendar)(propertyId, startDate, endDate, 'blocked');
            ...
            try {
                await (0, hostaway_api_1.updateHostawayPricing)(propertyId, startDate, endDate, eventData.price);
            ...
            try {
                await (0, hostaway_api_1.updateHostawayMinimumStay)(propertyId, startDate, endDate, eventData.minimumStay);
            ...
            try {
                await (0, hostaway_api_1.updateHostawayMaintenance)(propertyId, startDate, endDate, eventData.title || 'General Maintenance', eventData.description);
            ...
            try {
                await (0, hostaway_api_1.updateHostawayCleaning)(propertyId, startDate, endDate, eventData.title || 'General Cleaning', eventData.description);
...
async function updateAdvancedCalendarEventService(eventId, eventData, userId) {
    ...
    try {
        ...
        if (eventType === 'block' && originalEvent.source === 'manual') {
            ...
            try {
                await (0, hostaway_api_1.updateHostawayCalendar)(propertyId, originalEvent.startDate, originalEvent.endDate, 'available');
            ...
            try {
                await (0, hostkit_api_1.updateHostkitCalendar)(propertyId, originalEvent.startDate, originalEvent.endDate, 'available');
...
async function deleteAdvancedCalendarEventService(eventId, userId) {
    ...
    try {
        ...
        if (event.type === 'block' && event.source === 'manual') {
            ...
            // Try Hostaway API first
            try {
                await (0, hostaway_api_1.updateHostawayCalendar)(event.propertyId, event.startDate, event.endDate, 'available');
            ...
            // Try Hostkit API
            try {
                await (0, hostkit_api_1.updateHostkitCalendar)(event.propertyId, event.startDate, event.endDate, 'available');
...
async function getBulkOperationsService(userId) {
    // Simulate API delay
    await new Promise(resolve => setTimeout(resolve, 100));
    return mockBulkOperations;
}
async function createBulkOperationService(operationData, userId) {
            ...
            try {
                switch (type) {
                    case 'block_dates':
                        ...
                        try {
                            await (0, hostaway_api_1.updateHostawayCalendar)(propertyId, date, date, 'blocked');
                        ...
                        try {
                            await (0, hostkit_api_1.updateHostkitCalendar)(propertyId, date, date, 'blocked');
                    ...
                    case 'price_update':
                        ...
                        if (parameters.price) {
                            try {
                                await (0, hostaway_api_1.updateHostawayPricing)(propertyId, date, date, parameters.price);
                    ...
                    case 'minimum_stay_update':
                        ...
                        if (parameters.minimumStay) {
                            try {
                                await (0, hostaway_api_1.updateHostawayMinimumStay)(propertyId, date, date, parameters.minimumStay);
                    ...
                    case 'maintenance':
                        ...
                        if (parameters.maintenanceType) {
                            try {
                                await (0, hostaway_api_1.updateHostawayMaintenance)(propertyId, date, date, parameters.maintenanceType, parameters.reason);
                    ...
                    case 'cleaning':
                        ...
                        if (parameters.cleaningType) {
                            try {
                                await (0, hostaway_api_1.updateHostawayCleaning)(propertyId, date, date, parameters.cleaningType, parameters.reason);
                    ...
                    case 'coa_cod':
                        ...
                        if (parameters.checkInAvailable !== undefined && parameters.checkOutAvailable !== undefined) {
                            try {
                                await (0, hostaway_api_1.updateHostawayCOACOD)(propertyId, date, date, parameters.checkInAvailable, parameters.checkOutAvailable, parameters.reason);
...
async function getEventTemplatesService() {
    // Simulate API delay
    await new Promise(resolve => setTimeout(resolve, 100));
