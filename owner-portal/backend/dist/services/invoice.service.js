...
const getInvoicesService = async (listingId, startDate, endDate) => {
    try {
        const invoices = await (0, hostkit_api_1.getHostkitInvoices)(listingId, startDate, endDate);
