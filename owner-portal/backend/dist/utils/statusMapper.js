...
exports.mapPaymentStatus = exports.mapBookingStatus = void 0;
const mapBookingStatus = (rawStatus) => {
    if (!rawStatus) {
        return 'Unknown';
    }
...
exports.mapBookingStatus = mapBookingStatus;
const mapPaymentStatus = (rawPaymentStatus, bookingStatus) => {
