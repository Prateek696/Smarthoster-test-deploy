    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30 flex items-center justify-center">
        <div className="text-center">
          <div className="w-16 h-16 border-4 border-[#5FFF56] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
          <p className="text-lg text-gray-600">Loading properties and dashboard data...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30">
          ...
          <div className="flex justify-between items-center">
            <div className="max-w-2xl">
              <div className="inline-flex items-center gap-2 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-full border border-white/30 mb-6 shadow-lg">
                <div className="w-2 h-2 bg-[#5FFF56] rounded-full animate-pulse"></div>
              ...
              <div className="flex items-center gap-6">
                <div className="flex items-center gap-3 bg-white/90 backdrop-blur-sm px-6 py-3 rounded-2xl border border-white/30 shadow-lg hover:shadow-xl transition-all duration-300">
                  <div className="w-4 h-4 bg-[#5FFF56] rounded-full animate-pulse"></div>
      ...
      <div className="container mx-auto px-4 py-8">
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl border border-white/30 p-8 shadow-2xl">
            <div className="flex items-center justify-between mb-8">
              <div>
                ...
                <p className="text-gray-600">{t('dashboard.manageEfficiently')}</p>
              </div>
              <div className="w-14 h-14 bg-gradient-to-br from-[#00CFFF] to-[#0095D5] rounded-2xl flex items-center justify-center shadow-lg">
                <Settings className="h-7 w-7 text-white" />
              </div>
            </div>
            <div className="grid grid-cols-4 gap-6">
              <a href="/calendar" className="group flex flex-col items-center p-6 bg-gradient-to-br from-blue-50/80 to-blue-100/80 rounded-2xl hover:from-blue-100 hover:to-blue-200 transition-all duration-300 hover:scale-105 hover:shadow-lg">
                ...
                <span className="text-sm font-bold text-gray-900 text-center">{t('dashboard.viewCalendar')}</span>
              </a>
              
              <a href="/bookings" className="group flex flex-col items-center p-6 bg-gradient-to-br from-green-50/80 to-green-100/80 rounded-2xl hover:from-green-100 hover:to-green-200 transition-all duration-300 hover:scale-105 hover:shadow-lg">
                ...
                <span className="text-sm font-bold text-gray-900 text-center">{t('dashboard.manageBookings')}</span>
              </a>
              
              <a href="/invoices" className="group flex flex-col items-center p-6 bg-gradient-to-br from-purple-50/80 to-purple-100/80 rounded-2xl hover:from-purple-100 hover:to-purple-200 transition-all duration-300 hover:scale-105 hover:shadow-lg">
                ...
                <span className="text-sm font-bold text-gray-900 text-center">{t('dashboard.viewInvoices')}</span>
              </a>
              ...
              <button 
                ...
                className="group flex flex-col items-center p-6 bg-gradient-to-br from-orange-50/80 to-orange-100/80 rounded-2xl hover:from-orange-100 hover:to-orange-200 transition-all duration-300 hover:scale-105 hover:shadow-lg w-full"
              >
                ...
                <span className="text-sm font-bold text-gray-900 text-center">{t('dashboard.getSAFT')}</span>
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16">
          <div className="flex items-center justify-between mb-12">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-2">{t('dashboard.yourProperties')}</h2>
              <p className="text-lg text-gray-600">{t('dashboard.managePortfolio')}</p>
            </div>
            <div className="flex items-center gap-3 bg-white/90 backdrop-blur-sm px-6 py-3 rounded-2xl border border-white/30 shadow-lg">
              <div className="w-3 h-3 bg-[#5FFF56] rounded-full animate-pulse"></div>
              <span className="text-sm font-semibold text-gray-800">{displayData.properties.length} {t('dashboard.activePropertiesCount')}</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {displayData.properties.length > 0 ? (
              ...
              return (
                <div key={property._id || property.id || index} className="group bg-white/95 backdrop-blur-sm rounded-3xl border border-white/30 shadow-2xl hover:shadow-3xl transition-all duration-500 hover:-translate-y-3 overflow-hidden">
                  <div className="relative h-56 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200 flex items-center justify-center">
                    ...
                    <div className="absolute bottom-4 left-4">
                      <div className="bg-black/70 backdrop-blur-sm rounded-md px-3 py-2">
                        <h3 className="text-lg font-bold mb-1 text-white">{property.name}</h3>
                        <p className="text-xs text-white/90">{property.address || 'Algarve, Portugal'}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="p-8">
                    <div className="grid grid-cols-3 gap-6 mb-8">
                      <div className="text-center">
                        <p className="text-sm text-gray-500 mb-2 font-semibold">Type</p>
                        <p className="text-lg font-bold text-gray-900">{property.type}</p>
                      </div>
                      <div className="text-center">
                        <p className="text-sm text-gray-500 mb-2 font-semibold">Bedrooms</p>
                        <p className="text-lg font-bold text-gray-900">{property.bedrooms}</p>
                      </div>
                      <div className="text-center">
                        <p className="text-sm text-gray-500 mb-2 font-semibold">Max Guests</p>
                    ...
                    <div className="grid grid-cols-3 gap-2">
                      <button 
                        ...
                        className="flex items-center justify-center gap-2 px-3 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl hover:from-blue-600 hover:to-blue-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl"
                      >
                      ...
                      <button 
                        ...
                        className="flex items-center justify-center gap-2 px-3 py-3 bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-xl hover:from-purple-600 hover:to-purple-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl"
                      >
                      ...
                      <button 
                        ...
                        className="flex items-center justify-center gap-2 px-3 py-3 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-xl hover:from-green-600 hover:to-green-700 transition-all duration-300 font-semibold shadow-lg hover:shadow-xl"
                      >
              ...
              <div className="col-span-full text-center py-16">
                ...
                <button className="px-6 py-3 bg-gradient-to-r from-[#5FFF56] to-[#4FEF46] text-white rounded-2xl hover:from-[#4FEF46] hover:to-[#5FFF56] transition-all duration-300 font-bold shadow-lg hover:shadow-xl">
                  Add Property
                </button>
              </div>
            )}
      ...
      <div className="fixed bottom-8 right-8 z-50">
        <button className="w-14 h-14 bg-gradient-to-r from-[#5FFF56] to-[#4FEF46] rounded-full shadow-2xl hover:shadow-3xl transition-all duration-300 hover:scale-110 flex items-center justify-center group">
          <Settings className="h-6 w-6 text-white group-hover:rotate-180 transition-transform duration-300" />
        </button>
      </div>

      {/* Enhanced Background Decorative Elements */}
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/4 right-1/4 w-40 h-40 bg-[#5FFF56]/10 rounded-full blur-3xl "></div>
        <div className="absolute bottom-1/3 left-1/4 w-32 h-32 bg-[#00CFFF]/10 rounded-full blur-3xl -delayed"></div>
        <div className="absolute top-1/2 right-1/3 w-24 h-24 bg-purple-500/10 rounded-full blur-2xl "></div>
        <div className="absolute top-3/4 left-1/3 w-20 h-20 bg-orange-500/10 rounded-full blur-2xl -delayed"></div>
        <div className="absolute top-1/6 left-1/2 w-16 h-16 bg-green-500/10 rounded-full blur-xl "></div>
      </div>
    </div>
  )
}
